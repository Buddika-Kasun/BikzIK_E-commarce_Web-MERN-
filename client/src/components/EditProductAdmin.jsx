...
const EditProductAdmin = ({product, close, fetchProducts}) => {
    ...
    const handleAddImage = (e) => {
        setData({...data, image: [...data.image, e.target.files[0]] });
    };
    ...
    return (
        <section className="fixed top-0 right-0 bottom-0 left-0 bg-neutral-900 bg-opacity-60 p-4 flex justify-center z-50">
            <div className="bg-white max-w-2xl w-full rounded-md overflow-y-auto scroll-custom-blue relative">
                    ...
                    <form className="grid gap-3" onSubmit={handleSubmit}>
                        ...
                        <div className="grid">
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                rows={3}
                                className="outline-none border-[1.5px] border-blue-200 text-gray-500 focus:border-blue-300 bg-blue-100 bg-opacity-60 focus:bg-opacity-100 focus:shadow-sm px-2 py-1 rounded resize-none scroll-custom-blue"
                            />
                        </div>
                        ...
                        <div
                            className="hover:bg-blue-500 w-24 text-center px-2 rounded border-[1.5px] border-blue-500 hover:text-white font-semibold cursor-pointer text-blue-500"
                        ...
                        <button
                            className="bg-blue-500 text-white font-semibold px-4 py-1 mt-4 rounded hover:bg-blue-600"
                        >
                            Edit Product
                        </button>
